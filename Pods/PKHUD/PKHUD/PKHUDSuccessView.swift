...
public class PKHUDSuccessView: PKHUDSquareBaseView, PKHUDAnimating {
    ...
    var checkmarkShapeLayer: CAShapeLayer = {
        ...
        checkmarkPath.moveToPoint(CGPointMake(10.0, 17.0))
        checkmarkPath.addLineToPoint(CGPointMake(24.0, 36.0))
        checkmarkPath.addLineToPoint(CGPointMake(56.0, 0.0))
        
        let layer = CAShapeLayer()
        layer.frame = CGRectMake(3.0, 3.0, 56.0, 36.0)
